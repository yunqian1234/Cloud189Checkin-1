...
const push_config = {
  ...
  */
  ...
  WXPUSHER_APP_TOKEN: 'AT_OzwCik0QP4p4AQlKdO4jbgjWApTiWsJr', // wxpusher 的 appToken
  WXPUSHER_TOPIC_IDS: '', // wxpusher 的 主题ID，多个用英文分号;分隔 topic_ids 与 uids 至少配置一个才行
  WXPUSHER_UIDS: 'UID_515ENQo5aFZCOak8kkF8VTh7Va5p', // wxpusher 的 用户ID，多个用英文分号;分隔 topic_ids 与 uids 至少配置一个才行
};
